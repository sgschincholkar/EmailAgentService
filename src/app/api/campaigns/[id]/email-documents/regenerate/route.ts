...
import { RegenerateBlockRequestSchema } from "@/generation/regenerate-block-schema";
import {
  regenerateEmailDocumentBlock,
  RegenerateGenerationFailedError,
} from "@/generation/regenerate-email-document-block";
...
export async function POST(
  ...
  try {
    const document = await regenerateEmailDocumentBlock(
      campaignId,
    ...
    if (error instanceof RegenerateGenerationFailedError) {
